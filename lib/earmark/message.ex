defmodule Earmark.Message do
  ...
  @spec add_messages(container_type, messages) :: container_type
  def add_messages(container, messages), do:
    Enum.reduce(messages, container, &(add_message(&2, &1)))

  @spec add_message(container_type, message) :: container_type
  ...
  @spec get_messages( container_type ) :: messages
  ...
  @spec set_messages( Context.t, messages ) :: Context.t
  ...
  @spec format_message( String.t, message ) :: String.t
